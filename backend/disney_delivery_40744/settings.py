"""
Django settings for disney_delivery_40744 project.
...
ROOT_URLCONF = 'disney_delivery_40744.urls'
...
WSGI_APPLICATION = 'disney_delivery_40744.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "disney_delivery_40744 API",
    "DESCRIPTION": "API documentation for disney_delivery_40744 App",
    "VERSION": "v1",
}
